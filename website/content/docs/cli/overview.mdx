...
| [`ralph-tui listen`](/docs/cli/listen) | Start remote listener for remote control |
...
- **[listen](/docs/cli/listen)** - Start a WebSocket server for remote control of this instance
...
- **[listen](/docs/cli/listen)** - Server-side remote control setup
